...
app.post('/get_feed', function(req, res) {
  ...
  var api_key = 'EEj62gaJ6nDcFGorTUrwbhO2D0pbA469'; // TOOD: Remove null and replace with your API key you received at the setup
  ...
  if(title) {
    ...
    res.render('pages/NYTimes_home',{
      ...
      items: '',
      error: true,
      message: 'Sorry we cannot process your request because you didnt input a title'
    })
  }
});
