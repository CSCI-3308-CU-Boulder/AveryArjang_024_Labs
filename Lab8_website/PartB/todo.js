...
$(document).ready(function() {
        var url = `https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=cfb982dcda181d290bbf029505058d46 &tags=${filterTag}&privacy_filter=1&safe_search=1&extras=&per_page=${numPhotos}&page=&format=json&nojsoncallback=1`; //Place your Flickr API Call Here
        $.ajax({url:url, dataType:"json"}).then(function(data) {
