...
app.get('/home/pick_color', function(req, res) {
	...
	var color_message = 'select color_msg from favorite_colors where hex_value = $1 ;'; // Write! a SQL query to retrieve the color message for the selected color
    ...
    .then(info => {
    	res.render('pages/home',{
				...
				color_msg: info[0][1].color_msg // Return the color message
			})
    })
    .catch(err => {
            console.log('error', err);
...
app.post('/home/pick_color', function(req, res) {
	...
	var insert_statement = "INSERT INTO favorite_colors(hex_value, name, color_msg) VALUES($1, $2, $3) ON CONFLICT DO NOTHING;"; // Write a SQL statement to insert a color into the favorite_colors table
